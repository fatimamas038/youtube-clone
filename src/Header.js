...
function Header() {
    ...
    <input onChange={e=>setiSearch(e.target.value)} value={iSearch} placeholder="search" type="text"/>
    <Link to={`/search/${iSearch}`}>
